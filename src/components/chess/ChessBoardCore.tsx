...
export default function ChessBoardCore({ showMoveHelp = false }: ChessBoardCoreProps) {
  const {
    game,
    turn,
    makeMove,
          ...
          return (
            <div
              ...
              className={`square ${isLight ? "light" : "dark"} ${
                ...
                square?.type === "k" &&
                ((square.color === checkmate && currentIndex === lastIndex) ||
                 (square.color === timeoutWinner && timeoutWinner))
                  ? "checkmate"
                  : ""
              }`}
              onClick={() =>
